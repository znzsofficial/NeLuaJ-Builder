...
public class FileUtil implements ShutdownHook.ShutdownListener {
    private static final FileUtil INS;
    ...
    private static String getTmpDirRootName() {
        return Objects.requireNonNullElse(tmp_dir_root_name, "reandroid");
    }
    ...
    public static void copyFile(File srcFile, File destFile) throws IOException {
        ...
        FileOutputStream outputStream = getFileOutputStream(srcFile, destFile);
        outputStream.close();
    }

    @NonNull
    private static FileOutputStream getFileOutputStream(File srcFile, File destFile) throws IOException {
