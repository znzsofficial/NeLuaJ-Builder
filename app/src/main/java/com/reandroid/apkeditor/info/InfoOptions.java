...
//    }
    ...
    private static final String ARG_DESC_res = """
            Prints resource entries specified by either of:\
    ...
    private static final String ARG_DESC_filter_type = """
            Prints only the specified resource type names\
